...
public class SearchGui extends BaseGui {
    ...
    public SearchGui(RandomBlockDrops plugin) {
        super("&6Search Blocks/Items", 54);
        this.plugin = plugin;
        this.config = plugin.getBlockDropConfig();
    }
    
    public SearchGui(RandomBlockDrops plugin, String searchTerm) {
        super("&6Search: " + searchTerm, 54);
        this.plugin = plugin;
        this.config = plugin.getBlockDropConfig();
    ...
    public void setupInventory() {
        ...
        ItemStack searchInfo = GuiUtils.createItem(
            Material.PAPER,
            "&eSearch Instructions",
            "&7Type in chat to search for blocks/items",
            "&7Example: 'stone', 'diamond', 'wood'",
            "&7Current search: &a" + (searchTerm.isEmpty() ? "None" : searchTerm)
        );
        ...
        ItemStack newSearchButton = GuiUtils.createItem(
            ...
            "&7You'll be prompted to type in chat",
            "",
            "&eClick to search"
        );
    ...
    public void handleClick(InventoryClickEvent event) {
        ...
        if (slot == 45 && currentPage > 0) { // Previous page
            ...
            // Set up chat listener for search input
